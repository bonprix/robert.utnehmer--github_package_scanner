"""
Shai Hulud 2.0 Supply Chain Attack - Complete IOC Database
Updated from Wiz Security official IOC list (November 2024)

This file contains the complete and official list of compromised npm packages
from the Shai Hulud 2.0 worm attack campaign.

Attack Timeline: November 21-24, 2024
Total Compromised Packages: 795 unique packages
Package-Version Combinations: 1,089 total
Attack Vector: Preinstall script execution with obfuscated credential harvesting

Sources:
- https://github.com/wiz-sec-public/wiz-research-iocs/blob/main/reports/shai-hulud-2-packages.csv
- https://www.wiz.io/blog/shai-hulud-2-0-new-wave-of-supply-chain-worm-attacks
- https://socket.dev/blog/shai-hulud-2-malicious-npm-packages-worm-supply-chain

Attack Intelligence:
- Payload Files: setup_bun.js (10MB obfuscated), bun_environment.js  
- Execution: npm preinstall scripts with output suppression
- Targets: AWS, Azure, GCP credentials, Docker configs, SSH keys
- Exfiltration: webhook.site
- Persistence: GitHub Actions workflow injection
- Self-Propagation: Automated repository creation and package publishing

Affected Organizations:
- Zapier (16 packages)
- AsyncAPI (41 packages)
- Postman (17 packages)
- PostHog (52 packages)
- ENS Domains (46 packages)
- Voiceflow (56 packages)
- BrowserBase (8 packages)
- And hundreds more across various ecosystems

Impact: 25,000+ affected repositories across ~350 GitHub users
"""

# IOC Package Dictionary
# Format: package_name -> set of compromised versions
IOC_PACKAGES = {
    "02-echo": {"0.0.7"},
...
# GitHub Repository IOCs
GITHUB_IOCS = {
    "indicators": [
        "SHA1HULUD",  # Self-hosted runner identifier
        "setup_bun.js",  # Main payload file (10MB obfuscated)
        "bun_environment.js",  # Secondary payload
        ".github/workflows/discussion.yaml",  # Malicious workflow
        ".github/workflows/formatter_123456789.yml",  # Malicious workflow
    ],
    "patterns": [
        r"preinstall.*bun.*setup_bun\.js",  # Preinstall script pattern
        r"webhook\.site",  # Exfiltration domain
    ]
}
...
NETWORK_IOCS = {
    ...
    "file_artifacts": [
        "cloud.json",  # AWS credentials
        "contents.json",  # Repository contents
        "environment.json",  # Environment variables
        "truffleSecrets.json",  # Truffle secrets
    ]
}
