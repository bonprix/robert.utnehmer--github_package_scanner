"""
Shai Hulud 2.0 Worm Supply Chain Attack - November 2024

This file contains IOC definitions for the Shai Hulud 2.0 worm attack that compromised
over 25,000 repositories across ~350 unique users. This new campaign affects popular
packages including those from Zapier, ENS Domains, PostHog, and Postman.
...
Attack Type: Supply chain attack with worm payload, preinstall script execution
Attack Date: November 21-24, 2024
Threat Level: CRITICAL

Key Differences from Shai Hulud 1.0:
- Execution using preinstall lifecycle scripts
- New payload files: setup_bun.js and bun_environment.js
- Expanded targeting across PostHog, Postman, and AsyncAPI ecosystems
- Multi-cloud targeting (AWS, Azure, GCP)
- Docker privilege escalation attempts
- GitHub Actions workflow injection for persistence

Indicators of Compromise:
- GitHub repos with "Shai-Hulud" in description
...
IOC_PACKAGES = {
    ...
    "zapier-platform-schema": {"18.0.3", "18.0.4"},
    "zapier-scripts": {"7.8.3", "7.8.4"},

    # -------------------
    # AsyncAPI Packages (36 packages)
    # -------------------
    ...
    # -------------------
    # ENS Domains Packages (46 packages)
    # -------------------
    ...
    # -------------------
    # Voiceflow Packages (56 packages)
    # -------------------
    ...
    # -------------------
    # Accord Project Packages (6 packages)
    # -------------------
    ...
    # -------------------
    # Miscellaneous Scoped Packages (300+ packages)
    # -------------------
    ...
    # -------------------
    # Unscoped Packages (200+ packages)
    # -------------------
    "02-echo": {"0.0.7"},
    ...
    "bidirectional-adapter": {"1.2.2", "1.2.3"},
    "blob-to-base64": {"1.0.3"},
    "blinqio-executions-cli": {"1.0.41"},
    "bool-expressions": {"0.1.2"},
    "bytecode-checker-cli": {"1.0.8", "1.0.10", "1.0.11"},
    "bytes-to-x": {"1.0.1"},
...
# GitHub Indicators of Compromise
GITHUB_IOCS = {
    "malicious_workflows": [
...
# MITRE ATT&CK TTPs
ATTACK_TECHNIQUES = {
    "TA0001": "Initial Access - npm package versions listed above",
    "TA0002": "Execution - preinstall script in package.json",
    "TA0003": "Persistence - GitHub Actions workflow shai-hulud-workflow.yml",
    "TA0007": "Discovery - Access to /metadata/ endpoints in AWS/GCP/Azure",
    "TA0010": "Exfiltration - Outbound connections to webhook.site and GitHub repos",
    "TA0009": "Collection - data.json files containing encoded secrets",
}
